  ...
  resources: {
    en: {
      translation: {
        ...
        reviewsSubtitle:
          "Hear how VitalSync empowers proactive, preventive care.",

        review1Name: "Rina Sharma",
        review1Role: "Patient",
        review1Text:
          "VitalSync gave me clear, personalized advice about my reports. The AI insights and lifestyle tips help me feel more in control of my health.",
        ...
        ctaSubtitle:
          "Join VitalSync to transform how you and your doctor manage health, prevent risks, and stay ahead.",
        ...
        secureDecentralized:
          "VitalSync Health Platform • Secure • Decentralized • HIPAA Compliant",
    ...
    hi: {
      translation: {
        ...
        reviewsSubtitle:
          "जानिए कैसे VitalSync सक्रिय, निवारक देखभाल को सशक्त बनाता है।",

        review1Name: "रीना शर्मा",
        review1Role: "रोगी",
        review1Text:
          "VitalSync ने मुझे मेरी रिपोर्टों के बारे में स्पष्ट, व्यक्तिगत सलाह दी। एआई अंतर्दृष्टि और जीवनशैली सुझावों ने मुझे अपने स्वास्थ्य पर नियंत्रण का एहसास दिलाया।",
        ...
        ctaSubtitle:
          "VitalSync के साथ जुड़ें और यह बदलें कि आप और आपके डॉक्टर स्वास्थ्य का प्रबंधन कैसे करते हैं, जोखिमों को कैसे रोकते हैं और आगे कैसे रहते हैं।",
        ...
        secureDecentralized:
          "VitalSync स्वास्थ्य प्लेटफार्म • सुरक्षित • विकेंद्रीकृत • HIPAA अनुरूप",
